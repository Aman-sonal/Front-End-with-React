...
import {Breadcrumb , BreadcrumbItem, Button,ButtonGroup,Form, FormGroup,Label, Input,Col,Row, FormFeedback} from 'reactstrap';
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-md-10">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                <Label htmlFor="telnum" md={2}><b>Telephone Number</b></Label>
                                <Col md={10}>
                                    <Input type="text" id="telnum" name="telnum" placeholder="Telephone no." value={this.state.telnum} 
                                    valid={errors.telnum === ''}
